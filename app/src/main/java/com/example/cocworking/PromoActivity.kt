...
import kotlinx.android.synthetic.main.activity_convenzioni.*
...
class PromoActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //se clicco sul bottone "Convenzioni" apre un Activity
        text_convenzioni.setOnClickListener {
            val convenzione = Intent(applicationContext, ConvenzioniActivity::class.java)
            startActivity(convenzione)
        }
    }
